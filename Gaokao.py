...
5. 重要注意事项提醒"""
        ...
        client = OpenAI(base_url=base_url, api_key=st.secrets['API_KEY'])  # 修改为从secrets获取
...
with st.sidebar:
    ...
    user_subject = st.radio("报考科类", options=SUBJECT_TYPES, index=0, horizontal=True)
...
if 'messages' not in st.session_state:
    welcome_msg = """您好！我是智能择校助手小高，请先完善侧边栏的考生基本信息，
然后可以直接提问，例如：
- 我的分数能上哪些985大学？
- 推荐适合我的计算机专业院校
- 这个分数在省内的竞争力如何？"""
